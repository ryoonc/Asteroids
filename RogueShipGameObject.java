...
public class RogueShipGameObject extends GameObject {
	 ...
	 */
	public RogueShipGameObject(Game game, String ref, int x, int y, int currentAngle, int currentLevel, int shotTimer) {
		super(ref,x,y);
